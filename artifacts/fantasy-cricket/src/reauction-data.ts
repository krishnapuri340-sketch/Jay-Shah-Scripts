...
const ponygoat: RaTeam = {
  ...
  players: [
    ...
    { name: "Varun Chakravarthy", role: "BWL", ipl: "KKR",  price: 8,    isNew: true, frozenPts: 66,  preAuctionOffset: 258, replacedName: "Tim Seifert" },
    ...
    { name: "Quinton de Kock",    role: "WK",  ipl: "MI",   price: 3.5,  isNew: true, frozenPts: 170, preAuctionOffset: 282, replacedName: "Khaleel Ahmed" },
...
const mumbai: RaTeam = {
  ...
  players: [
    ...
    { name: "Vijaykumar Vyshak",  role: "BWL", ipl: "PBKS", price: 4,    isNew: true, frozenPts: 187, preAuctionOffset: 276, replacedName: "Finn Allen" },
